...
const Icon = ({ children, size = 18, ...rest }: { children: React.ReactNode; size?: number } & Omit<React.SVGProps<SVGSVGElement>, 'children'>) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
export const Icons: Record<string, IconDef> = {
  ...
  Layers: (p) => <Icon {...p}><path d="M2 9.5L12 4l10 5.5L12 15z"/><path d="M2 14.5L12 20l10-5.5"/></Icon>,
  Wallet: (p) => <Icon {...p}><path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1"/><path d="M3 10h18"/><path d="M16 14h5"/></Icon>,
  ...
  CheckCircle: (p) => <Icon {...p}><circle cx="12" cy="12" r="10"/><polyline points="9 12 11 14 16 9"/></Icon>,
  X: (p) => <Icon {...p}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></Icon>,
  Trash: (p) => <Icon {...p}><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1.5 14a2 2 0 0 1-2 1.5h-7a2 2 0 0 1-2-1.5L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/></Icon>,
  ...
  Download: (p) => <Icon {...p}><path d="M19 14v6a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-6"/><polyline points="9 11 12 14 15 11"/><line x1="12" y1="14" x2="12" y2="2"/></Icon>,
  TrendUp: (p) => <Icon {...p}><polyline points="22 7 13.5 15.5 8.5 10.5 1 18"/><polyline points="16 7 22 7 22 13"/></Icon>,
  TrendDown: (p) => <Icon {...p}><polyline points="22 17 13.5 8.5 8.5 13.5 1 6"/><polyline points="16 17 22 17 22 11"/></Icon>,
